#!/usr/bin/env bash
# install-agent-rules.sh — install NERSC's agent rules into a CLAUDE.md.
#
...
# ~/.claude/CLAUDE.md, delimited by managed markers.
#
...
#
#   ./scripts/install-agent-rules.sh                       # install into ~/.claude/CLAUDE.md
